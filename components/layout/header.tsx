          ...
          >
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-cyan-400/20 to-blue-500/20 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              </div>
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="p-6 border-b border-white/10">
                  ...
                  >
                    ...
                    <div>
                      <div className="font-semibold text-white">Abdellatif GOURRI</div>
                      <div className="text-xs text-gray-400 font-mono">Développeur Full-Stack</div>
                    </div>
                  </Link>
                </div>
